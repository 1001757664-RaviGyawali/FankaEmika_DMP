...
class SetJointConfigurationRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetJointConfigurationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetJointConfigurationRequest
    let len;
    let data = new SetJointConfigurationRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetJointConfigurationRequest(null);
...
class SetJointConfigurationResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetJointConfigurationResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetJointConfigurationResponse
    let len;
    let data = new SetJointConfigurationResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'franka_msgs/SetJointConfigurationResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetJointConfigurationResponse(null);
...
module.exports = {
  ...
  Response: SetJointConfigurationResponse,
  md5sum() { return '772aebee560c498b58210c453ba3c24c'; },
  datatype() { return 'franka_msgs/SetJointConfiguration'; }
};
